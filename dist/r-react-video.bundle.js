	  ...
	  _createClass(ReactVideo, [{
	    ...
	    value: function renderSingleView() {
	      ...
	      return singleViewVisible ? _react2.default.createElement(
	        ...
	        mode === 'edit' ? _react2.default.createElement("iframe", { className: "renderArea", src: singleView.link }) : _react2.default.createElement(_Responses2.default, { data: singleView })
	      ) : null;
	    }
	  }, {
	    ...
	    value: function navigateItems(direction) {
	      ...
	      var itemsArePromised = !Array.isArray(items) && items.hasOwnProperty('then');
	      if (!itemsArePromised) {
	      ...
	      var _checkSingleViewNavSt = this.checkSingleViewNavState(nextIndex),
	          ...
	          singleViewDisablePrev = _checkSingleViewNavSt2[0],
	          singleViewDisableNext = _checkSingleViewNavSt2[1];
