	...
	var Responses = function (_PureComponent) {
	    ...
	    _createClass(Responses, [{
	        ...
	        get: function get() {
	            ...
	            return _react2.default.createElement('img', { className: 'Responses--media', src: data.image });
	        }
	    }, {
	        key: '_videoRenderer',
	        get: function get() {
	        ...
	        get: function get() {
	            ...
	            return _react2.default.createElement('audio', { src: data.audio, type: 'audio/mp4', controls: true, className: 'Responses--media' });
	        }
	    }]);
